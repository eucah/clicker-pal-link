...
const GRID_INPUT_FOCUS_CLASSNAME =
  "h-6 text-xs font-mono transition-colors focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0 focus:border-foreground";
  ...
  <tr className="border-b border-border/80">
    ...
    <td className="py-0.5 pr-1">
      <Input
        ...
        className={GRID_INPUT_FOCUS_CLASSNAME}
        placeholder="Fils..."
      />
    </td>
    <td className="py-0.5 pr-1">
