...
const ProjectEditor = ({ onSave, onAccess, onCancel }: ProjectEditorProps) => {
  ...
  return (
    <div className="h-screen bg-background flex flex-col overflow-hidden safe-area-all">
      <header className="flex items-center gap-2 px-6 py-1.5 landscape:py-1 border-b border-border bg-card shrink-0">
      ...
      <div className="px-6 py-1.5 landscape:py-1 border-b border-border shrink-0">
