...
const gridInputClassName =
  "h-6 text-xs font-bold transition-colors focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0 focus:border-foreground focus-visible:border-foreground";
