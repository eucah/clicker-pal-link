...
const ButtonGrid = ({ isMaster, states, buttonInfos, selectedIndex, onToggle, onSelect }: ButtonGridProps) => {
  ...
  return (
    <div className="flex flex-col landscape:flex-row items-center landscape:items-stretch px-4.5 gap-3 landscape:gap-2 p-2 landscape:px-[env(safe-area-inset-left,8px)] landscape:pr-[env(safe-area-inset-right,8px)] w-full h-full">
      ...
      <div className="flex flex-col px-4.5 gap-[3px] landscape:gap-[2px] w-full landscape:w-1/2 landscape:justify-evenly">
