  ...
  const renderButton = (stateIndex: number, label: number) => {
    ...
    return (
      <button
        ...
        className={`aspect-square rounded-full flex items-center shadow-xl shadow-netral-700/30 justify-center flex-shrink-0 transition-colors duration-150 text-[10px] landscape:text-[9px] font-bold !text-black dark:!text-black ${
          isLocked
